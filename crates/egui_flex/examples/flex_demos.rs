...
fn main() -> eframe::Result {
    ...
    eframe::run_simple_native("egui_flex demos", Default::default(), move |ctx, _frame| {
                ...
                .show(ui, |flex| {
                    flex.add_flex_frame(
                        ...
                        |flex| {
                            ...
                            .iter()
                            .for_each(|align| {
                                flex.add_frame(FlexItem::new().align_self(*align), frame, |ui| {
                    ...
                    flex.add_flex_frame(
                        ...
                        |flex| {
                            ...
                            [0.0, 1.0, 2.0, 3.0].iter().for_each(|grow| {
                    ...
                    flex.add_flex_frame(
                        ...
                        |flex| {
                            ...
                            [0.0, 50.0, 100.0, 200.0].iter().for_each(|basis| {
