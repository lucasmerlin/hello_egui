...
macro_rules! asyncify {
    (
        ...
        $crate::fnify!{
            ...
            $name,
            body: $body,
            parameters: ($($arg: $type,)* $callback_name: impl FnMut($($closure_arg,)* $callback_type) $($bounds)*,),
            async_body: {
            ...
            async_parameters: ($($arg: $type,)* ;mut future_fn: $future,),
            call_args: ($($arg,)*),
            generics: ($($gen)*),
    ...
    (
        ...
        $crate::fnify!{
            ...
            $name,
            body: $body,
            parameters: ($($arg: $type,)* $callback_name: impl FnOnce($callback_type) $($bounds)*,),
            async_body: {
            ...
            async_parameters: ($($arg: $type,)* ;mut future: $future,),
            call_args: ($($arg,)*),
            generics: ($($gen)*),
            async_generics: ($($async_gen)*),
            return_type: ($($return_type)*),
